...
typedef VariableDeclarationList = {
	final kind : Int;
	final parent : ts.AnyOf4<VariableStatement, ForStatement, ForInStatement, ForOfStatement>;
	final declarations : NodeArray<VariableDeclaration>;
