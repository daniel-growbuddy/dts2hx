...
typedef ExportDeclaration = {
	final kind : Int;
	final parent : ts.AnyOf2<SourceFile, ModuleBlock>;
	final isTypeOnly : Bool;
	/**
		Will not be assigned in the case of `export * from "foo";`
	**/
	@:optional
	final exportClause : NamedExportBindings;
	/**
		If this is not a StringLiteral it will be a grammar error.
	**/
	@:optional
	final moduleSpecifier : Expression;
	@:optional
