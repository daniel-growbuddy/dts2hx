...
typedef SortedArray<T> = {
	@:native(" __sortedArrayBrand")
	var ___sortedArrayBrand : Dynamic;
	/**
	...
	**/
	...
	/**
		Sorts an array.
	**/
	function sort(?compareFn:(a:T, b:T) -> Float):SortedArray<T>;
	/**
	...
	**/
	function fill(value:T, ?start:Float, ?end:Float):SortedArray<T>;
	/**
		Returns the this object after copying a section of the array identified by start and end
		to the same array starting at position target
	**/
	function copyWithin(target:Float, start:Float, ?end:Float):SortedArray<T>;
	/**
