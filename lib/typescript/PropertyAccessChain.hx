...
typedef PropertyAccessChain = {
	var _optionalChainBrand : Dynamic;
	final name : ts.AnyOf2<Identifier, PrivateIdentifier>;
	final kind : Int;
	final expression : LeftHandSideExpression;
	@:optional
	final questionDotToken : QuestionDotToken;
