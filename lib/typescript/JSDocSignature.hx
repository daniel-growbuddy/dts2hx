...
typedef JSDocSignature = {
	final kind : Int;
	@:optional
	final typeParameters : haxe.ds.ReadOnlyArray<JSDocTemplateTag>;
	final parameters : haxe.ds.ReadOnlyArray<JSDocParameterTag>;
	final type : Null<JSDocReturnTag>;
